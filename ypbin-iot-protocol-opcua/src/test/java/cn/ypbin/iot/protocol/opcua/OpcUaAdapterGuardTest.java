...
class OpcUaAdapterGuardTest {
    ...
    void unsupportedSecurityPolicyMustFailFast() {
        OpcUaAdapter secured = new OpcUaAdapter(new OpcUaProperties(true, "http://opcfoundation.org/UA/SecurityPolicy#Basic256Sha256", "SIGN_AND_ENCRYPT", Duration.ofSeconds(2), Duration.ofMillis(200), 100, 1, 100, null, null, null, null, null, null, null));
    ...
    void probeMustSurfaceConfigurationErrors() {
        ...
        OpcUaAdapter secured = new OpcUaAdapter(new OpcUaProperties(true, "http://opcfoundation.org/UA/SecurityPolicy#Basic256Sha256", "SignAndEncrypt", Duration.ofSeconds(2), Duration.ofMillis(200), 100, 1, 100, null, null, null, null, null, null, null));
    ...
    void credentialsOverPlaintextMustFailFast() {
        ...
        OpcUaAdapter withCredentials = new OpcUaAdapter(new OpcUaProperties(true, null, null, null, null, null, null, null, null, null, null, null, null, null, null));
    ...
    void nonNonePolicyMustReachConnectionAttempt() {
        ...
        OpcUaAdapter secured = new OpcUaAdapter(new OpcUaProperties(true, "http://opcfoundation.org/UA/SecurityPolicy#Basic256Sha256", "SignAndEncrypt", Duration.ofSeconds(2), Duration.ofMillis(200), 100, 1, 100, null, "opcua-ref", "/nonexistent/client.p12", null, tempDir.toString(), null, null));
    ...
    void trustAllMustBeUsable() {
        OpcUaProperties properties = new OpcUaProperties(true, null, null, null, null, null, null, null, null, null, null, null, null, Boolean.TRUE, null);
        assertThat(properties.isTrustAll()).isTrue();
        assertThat(new OpcUaProperties(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null).isTrustAll()).as("默认必须关闭 trust-all").isFalse();
    }
    ...
    void propertiesMustNormalizeDefaults() {
        OpcUaProperties defaults = new OpcUaProperties(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        ...
        assertThat(new OpcUaProperties(true, null, null, null, null, 0, -1, 0, null, null, null, null, null, null, null).maxNodesPerRead())
                .as("非正数必须回落到默认值而不是带病运行")
                .isEqualTo(OpcUaProperties.DEFAULT_MAX_NODES_PER_READ);
        assertThat(new OpcUaProperties(true, "  ", "  ", null, null, null, null, null, null, null, null, null, null, null, null).isPlaintext()).isTrue();
        assertThat(new OpcUaProperties(true, "http://x", "SIGN", null, null, null, null, null, null, null, null, null, null, null, null)
                .isPlaintext()).isFalse();
    }
